        ...
        <main className="w-full max-w-2xl px-4 py-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                {winners.map((winner) => (
                  <div
                    ...
                    className={`flex items-center justify-between p-2 rounded-lg text-sm ${
                      winner.awarded ? 'bg-black text-white' : 'bg-gray-700 text-gray-300'
                    }`}
                  >
                    {/* Esquerda: número do título/bilhete, caindo para id se não houver */}
                    <span
                    ...
                    {/* Centro: NOME DO PRÊMIO */}
                    <span className="flex-1 text-center font-semibold">
                      {winner.prizeName || '—'}
                    </span>

                    {/* Direita: nome do ganhador se premiado */}
            ...
            <div className="bg-gray-800 rounded-lg shadow-sm p-4 text-gray-400 space-y-3 h-48 overflow-y-auto text-sm">
              ...
              <p>
                Ação totalmente instantânea, achando qualquer bilhete premiado disponível você recebe uma ligação
                e recebe seus prêmios!
              </p>
